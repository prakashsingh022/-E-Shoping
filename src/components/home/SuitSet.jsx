      ...
      <div className="container-custom px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-12">
          {loading ? (
            ...
            <div
              key={product._id}
              className="group flex flex-col h-full bg-white rounded-[20px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 card-hover-effect relative"
            >
              <Link to={`/product/${product._id}`} className="flex flex-col h-full">
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute inset-0 bg-slate-950/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4 z-10">
                    <div className="flex justify-end">
                      <button
                        ...
                        className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-900 shadow-lg hover:bg-primary-gold hover:text-white transition-colors"
                      >
                    ...
                    <div className="flex gap-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      <div
                        className="flex-1 bg-white text-slate-900 py-3 rounded-xl font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-primary-gold hover:text-white transition-all shadow-md duration-300"
                      >
                        View Details
                      </div>
                    </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <button
                      ...
                      className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center hover:bg-primary-gold transition-all duration-300 active:scale-90 shadow-lg shadow-slate-950/10 hover:shadow-primary-gold/20 z-10"
                    >
