...
import { luxeSetProducts as products } from "../../data/productData";
              ...
              <div className="p-8 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    <span className="text-2xl font-black text-slate-950">₹{product.priceAfter}</span>
                    <span className="text-sm text-slate-400 line-through font-medium">₹{product.priceBefore}</span>
                  </div>
